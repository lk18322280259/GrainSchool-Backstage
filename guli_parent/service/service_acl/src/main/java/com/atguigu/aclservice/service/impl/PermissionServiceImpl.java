 ...
 * @since 2020-01-12
 */
@SuppressWarnings({"AlibabaCommentsMustBeJavadocFormat", "SimplifyStreamApiCallChains", "ForLoopReplaceableByForEach", "CommentedOutCode", "AlibabaUndefineMagicConstant", "RedundantIfStatement", "AlibabaRemoveCommentedCode", "UnusedAssignment", "Convert2Diamond"})
@Service
...
//        });
    ...
    public void saveRolePermissionRealtionShipGuli(String roleId, String[] permissionIds) {
        ...
        for(String perId : permissionIds) {
            ...
            queryWrapper.eq(RolePermission::getPermissionId, perId);
            int count = rolePermissionService.count(queryWrapper);
            if(count>0) {
                //删除原纪录
